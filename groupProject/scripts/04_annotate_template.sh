...
#SBATCH -o /sciclone/home/rlgeorgeambroc/logs/REPLACEME_anno_%j.out # change this!
#SBATCH -e /sciclone/home/rlgeorgeambroc/logs/REPLACEME_anno_%j.err # change this!
